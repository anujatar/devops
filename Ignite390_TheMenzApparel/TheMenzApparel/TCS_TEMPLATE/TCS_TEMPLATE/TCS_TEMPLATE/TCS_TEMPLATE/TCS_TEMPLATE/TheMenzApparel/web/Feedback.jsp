...
<!--                                                    <li><a href="#">Jackets</a></li>
                                        ...
                                        <!--/.slider start -->          
                                        <div class="span8">
                                            <form class="form-signin" style="width: 369px; margin-left: 234px;" action="feedback" method="post">
                                                <br><br><br><br><br><br><br><br><h2 class="form-signin-heading">Feedback Form</h2>
                                                <br>
                                                <br>
                                                <table>
                                                    <tr>
                                                        <td>Email:</td>
                                                        <td><input type="text" class="input-block-level" placeholder="Email address" id="emailfeed" name="emailfeed"></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Password:</td>
                                                        <td><input type="password" class="input-block-level" placeholder="Password" id="passfeed" name="passfeed"></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Feedback:</td>
                                                        <td><textarea rows="4" id="feedFeed" name="feedFeed"></textarea></td>
                                                    </tr>
                                                    <tr>
                                                        <td></td>
                                                        <td><button class="btn btn-large btn-primary" type="submit" id="subfeed">Submit</button></td>
                                                    </tr>
